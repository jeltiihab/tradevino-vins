...
import styles from "./CoteauxDesGirondales2.module.css";

const CoteauxDesGirondales2 = () => {
  ...
  return (
    <div className={styles.coteauxDesGirondales}>
      ...
      <img className={styles.image32Icon} alt="" src="/image-331@2x.png" />
...
export default CoteauxDesGirondales2;
